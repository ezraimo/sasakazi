...
<html>
<head>
	<title>Sasakazi apllicant's records</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="container">
	<img src="c.png" alt="" width="350px" ><br><br>
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
				...
				<th class="text-center" scope="col">Applicant Id.</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="c.png" width="300px" height="80px" alt=""></center>
        <h4 class="modal-title text-center">Add new applicant</h4>
      </div>
...
<label for="family">Referee</label>
...
<select name="state" class="form-control">
  <option selected>Choose...</option>
  <option value="Andhra Pradesh">County</option>
									<option value="Andaman and Nicobar Islands">Baringo</option>
									<option value="Arunachal Pradesh">Bomet</option>
									<option value="Assam">Bungoma</option>
									<option value="Bihar">Turkana</option>
									<option value="Chandigarh">Marsabit</option>
									<option value="Chhattisgarh">Mandera</option>
									<option value="Dadar and Nagar Haveli">Lamu</option>
									<option value="Daman and Diu">Garisa</option>
									<option value="Delhi">Tana river</option>
									<option value="Lakshadweep">Kilifi</option>
									<option value="Puducherry">Uasin-Gishu</option>
									<option value="Goa">Nandi</option>
									<option value="Gujarat">Migori</option>
									<option value="Haryana">Nakuru</option>
									<option value="Himachal Pradesh">Nairobi</option>
									<option value="Jammu and Kashmir">Mombasa</option>
									<option value="Jharkhand">Nyandarua</option>
									<option value="Karnataka">Nyamira</option>
									<option value="Kerala">Kisii</option>
									<option value="Madhya Pradesh">Kericho</option>
									<option value="Maharashtra">Machakos</option>
									<option value="Manipur">Kisumu</option>
									<option value="Meghalaya">Muranga</option>
									<option value="Mizoram">Embu</option>
									<option value="Nagaland">Laikipia</option>
									<option value="Odisha">Nyeri</option>
									<option value="Punjab">Wajir</option>
									<option value="Rajasthan">Makueni</option>
									<option value="Sikkim">Kitui</option>
									<option value="Tamil Nadu">Isiolo</option>
									<option value="Telangana">Siaya</option>
									<option value="Tripura">Vihiga</option>
									<option value="Uttar Pradesh">Mombasa</option>
									<option value="Uttarakhand">Kakamega</option>
									<option value="West Bengal">Busia</option>
</select>
</div>
...
<div class="form-group">
<label for="inputAddress">Staff Id one who Did The Interview To The Applicant.</label>
